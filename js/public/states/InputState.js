...
var InputState = /** @class */ (function () {
    function InputState(stateStack, question, regex) {
        this.stateStack = stateStack;
        this.question = question;
        this.regex = regex;
        this.element = new InputModalElement();
        this.answer = null;
        State.call(this, stateStack);
    }
    InputState.prototype.preload = function () {
    ...
    InputState.prototype.createModal = function () {
        var _this = this;
        ...
        this.element.evtHandler.addEventListener('confirm', function (value) {
            if (_this.element.valueIsValid) {
                console.log(value);
                _this.answer = value;
                _this.remove();
            }
        ...
        this.evtHandler.addEventListener('remove', function () {
            _this.stateStack.game.input.preventDefault = true;
